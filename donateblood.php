  ...
  <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      if($res==true)
           {
              // echo 'data inserted';
              $_SESSION['donate-blood-succesfull'] = "<div class='success'>Succesfully ordered blood</div>";
              header('location:'.SITEURL.'dashbord.php?id='.$id);
           }
          else
           {
              // echo 'data inserted';
              $_SESSION['donate-blood-unsuccesfull'] = "<div class='error'>Unsuccefull to order blood</div>";
              header('location:'.SITEURL.'dashbord.php?id='.$id);
           }
