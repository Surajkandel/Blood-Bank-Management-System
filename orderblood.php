  ...
  <div class="container">
    ...
    <form action="" method="POST" enctype = 'multipart/form-data'>
      ...
      <div class="info">
        ...
        <input type="number" min="1" id="age" name="age" required><br>
  ...
  <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $bloodtype = $_POST['type'];
           ...
           {
              // echo 'data inserted';
              $_SESSION['order-blood-succesfull'] = "<div class='success'>Succesfully ordered blood</div>";
              header('location:'.SITEURL.'dashbord.php?id='.$id);
           }
          else
           {
              // echo 'data inserted';
              $_SESSION['order-blood-unsuccesfull'] = "<div class='error'>Unsuccefull to order blood</div>";
              header('location:'.SITEURL.'dashbord.php'.$id);
           }
